...
exports.getUserAccessibleBoards = exports.getAllBoardAccess = exports.setBoardAccess = exports.getBoardAccess = void 0;
...
const getBoardAccess = async (req, res) => {
    ...
    try {
        // 1. 게시판 정보 조회
        const board = await Board_1.default.findByPk(boardType);
        if (!board) {
        ...
        for (const access of accessList) {
            const role = await Role_1.Role.findByPk(access.roleId);
            if (role) {
...
exports.getBoardAccess = getBoardAccess;
// ✅ 게시판 접근 권한 설정
const setBoardAccess = async (req, res) => {
    ...
    try {
        // 기존 권한 삭제
        await BoardAccess_1.default.destroy({ where: { boardId: boardType } });
        // 새 권한 생성
        ...
        await BoardAccess_1.default.bulkCreate(entries);
...
exports.setBoardAccess = setBoardAccess;
// ✅ 전체 게시판 + 권한 목록 조회
const getAllBoardAccess = async (req, res) => {
    try {
...
exports.getAllBoardAccess = getAllBoardAccess;
// ✅ 사용자가 접근 가능한 게시판 목록 조회 (수정됨)
const getUserAccessibleBoards = async (req, res) => {
    try {
        const userRole = req.user?.role; // 인증된 사용자의 역할 ID
        if (!userRole) {
...
exports.getUserAccessibleBoards = getUserAccessibleBoards;
